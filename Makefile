...
COMPILED_CSS := $(addprefix $(COMPILED_DIR)/,f-list.css f-branding.css f-hero.css f-navigation.css f-huge-heading.css f-one-liner.css f-left-heading.css f-text-input.css f-cuff-text.css f-spacer.css f-footer-text.css f-right-heading.css f-content.css f-donation-amount.css) 
