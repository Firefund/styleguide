...
PROD_CSS_BUNDLE := styles/bundle.css styles/base.css styles/grid.css styles/icons.css styles/blocks/f-content.css styles/blocks/f-left-heading.css styles/blocks/f-text.css styles/blocks/f-media.css styles/blocks/f-white-card.css styles/blocks/f-button-group.css styles/blocks/f-spacer.css styles/blocks/f-one-liner.css styles/blocks/f-list.css styles/blocks/f-footer.css styles/blocks/f-sitemap.css styles/blocks/f-signup.css styles/blocks/f-icon-list.css styles/blocks/f-footer-text.css styles/blocks/f-accordian.css styles/blocks/f-radio-group.css styles/blocks/f-text-input.css styles/blocks/f-button-basic.css styles/blocks/f-team-cards.css styles/blocks/f-huge-heading.css styles/blocks/f-info-card.css styles/blocks/f-button-organize.css styles/blocks/f-hero.css styles/blocks/f-progress.css styles/blocks/f-project-thumbnail.css styles/blocks/f-miniproject-thumbnail.css styles/blocks/f-button-donate.css styles/blocks/f-button-icon.css styles/blocks/f-right-heading.css styles/blocks/f-modal.css styles/blocks/f-payment-form.css
